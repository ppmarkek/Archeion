...
- **Tabbed workspace:** files open in a rounded browser-style tab rail at the very top of the workspace, with the document toolbar directly beneath it, and restore locally between sessions. Keep at most eight files open and at most four visible at once. An active tab can occupy the center, left, right, top, or bottom slot; inactive open tabs remain in the rail without consuming canvas space.
